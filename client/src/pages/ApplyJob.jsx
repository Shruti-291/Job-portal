...
const ApplyJob = () => {
  ...
  return JobData ? (
    <>
      <Navbar/>
      <div className='min-h-screen flex flex-col py-10 container px-2 2xl:px-20 mx-auto'>
        <div className='bg-white text-black rounded-lg w-full'>
          <div className='flex justify-center md:justify-between flex-wrap gap-8 px-14 py-20 mb-6 bg-sky-50 border border-sky-400 rounded-xl'>
            ...
            text-end text-sm max-md:mx-auto max-md:text-center'>
          ...
          px-2 py-10 bg-white shadow-sm rounded-md'>
